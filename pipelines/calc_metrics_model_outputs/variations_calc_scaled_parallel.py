...
BASE_OUT_ROOT = "/mnt/dave/lilian/DIG_VARIATION_OUTPUTS/dig_variations_combinedMDGT"
...
MODEL_NAMES = [
    "dig_with_init_cdr_mask_trA0.2_rotA0.2_trB0.1_rotB0.1",
    "dig_with_init_trA0.2_rotA0.2_trB0.1_rotB0.1"
]
...
def run_one(config_path: str, config_name: str, model_name: str):
    ...
    run_all_TCRs_collect(
        ...
        linker=linker,
        fit_on=FIT_ON,
        #GT_MD_FOLDER="/mnt/larry/lilian/DATA/Oriol_adaptive_sampling/combined_with_cory" #if you want to run on combined MD and adaptive sampling
    )
...
if __name__ == "__main__":
    ...
    MAX_WORKERS = 1  # e.g. 2–4; if GPU-limited, you can even set to 1
