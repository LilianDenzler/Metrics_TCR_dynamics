...
def run(tv_gt, tv_pred, outdir, regions,  rmsd_superpose=False,max_pairs=None, reducer="pca",
        n_components=2, fit_on="gt", pred_share=0.2, trust_k=10, lag=5,
        subsample=None, mantel_perms=9999, mantel_method="spearman", seed=0):
...
def make_all_space_model(tv_gt_list, tv_pred_list, regions, max_pairs=None, rmsd_superpose=False,
    ...
    if reducer in ("pca","pca_weighted","concat","gt","pred"):
        model, Zg, Zp, info = fit_pca_linear(X_global_gt, X_global_pr, n_components, fit_on=fit_on,
...
def run_all_tcr_space(tv_gt_list, tv_pred_list, outdir_list, regions, rmsd_superpose=False,max_pairs=None, reducer="pca",
        n_components=2, fit_on="gt", pred_share=0.2, trust_k=10, lag=5,
        subsample=None, mantel_perms=9999, mantel_method="spearman", seed=0):
    model, Zg_all, Zp_all, info_all = make_all_space_model(
        tv_gt_list, tv_pred_list, regions, max_pairs,
